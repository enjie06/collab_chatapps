...
<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto py-8 flex flex-col gap-8 md:grid md:grid-cols-2">
        ...
        <div class="order-1 md:order-2">
            ...
            {{-- Tambah Teman --}}
            <h3 class="font-semibold text-lg text-gray-700 mb-3">Tambah Teman</h3>
            ...
            <div class="flex items-center justify-between mb-2">
                <h3 class="font-semibold text-lg text-gray-700">Kontak</h3>
            </div>
            ...
            {{-- Permintaan Masuk --}}
            @if($incoming->count())
                <h3 class="font-semibold text-lg text-gray-700 mt-6 mb-2">Permintaan Masuk</h3>
        ...
        <div class="order-2 md:order-1">
            ...
            @forelse($conversations as $conversation)
                @php
                    $partner = $conversation->users->firstWhere('id', '!=', auth()->id());
                ...
                <a href="{{ route('chat.show', $conversation->id) }}"
                   class="block p-4 mb-3 bg-white border rounded-lg hover:bg-rose-50 transition relative">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex-1">
                            <strong class="text-rose-600">{{ $partner->name }}</strong>
